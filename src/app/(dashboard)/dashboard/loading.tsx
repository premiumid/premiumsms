    ...
    <div className="catalog-grid-layout">
      ...
      <main className="catalog-main">
        <div className="catalog-header">
          <div style={{ width: '40%', height: 24, borderRadius: 6, background: 'var(--bg-tertiary)', marginBottom: '0.5rem' }} />
      ...
      <aside className="catalog-right">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center', padding: '2rem 1rem' }}>
          ...
          <div style={{ width: '70%', height: 20, borderRadius: 6, background: 'var(--bg-tertiary)' }} />
          <div style={{ width: '90%', height: 14, borderRadius: 4, background: 'var(--bg-tertiary)' }} />
          <div style={{ width: '100%', height: 44, borderRadius: 9999, background: 'var(--bg-tertiary)', marginTop: '1rem' }} />
        </div>
      </aside>
    </div>
  )
